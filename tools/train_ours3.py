...
from ours3_spformer.dataset import build_dataloader, build_dataset
from ours3_spformer.evaluation import ScanNetEval
from ours3_spformer.model import OurSPFormer3
from ours3_spformer.utils import AverageMeter, get_root_logger


def get_args():
    parser = argparse.ArgumentParser('OurSPFormer3')
...
def main():
    ...
    model = OurSPFormer3(**cfg.model).cuda()
