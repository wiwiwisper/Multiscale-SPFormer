...
from ours_spformer.dataset import build_dataloader, build_dataset
from ours_spformer.evaluation import ScanNetEval
from ours_spformer.model import OurSPFormer
from ours_spformer.utils import AverageMeter, get_root_logger


def get_args():
    parser = argparse.ArgumentParser('OurSPFormer')
...
def main():
    ...
    model = OurSPFormer(**cfg.model).cuda()
