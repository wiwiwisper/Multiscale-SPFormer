...
from .myplants import MyPlantsDataset 

__all__ = ['ScanNetDataset',  'MyPlantsDataset', 'build_dataset', 'build_dataloader']
...
def build_dataset(data_cfg, logger):
    ...
    elif data_type == 'myplants':  # 加上 myplants
        return MyPlantsDataset(**_data_cfg)
    else:
