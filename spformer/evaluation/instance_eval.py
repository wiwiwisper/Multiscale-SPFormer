...
class ScanNetEval(object):
    ...
    def print_results(self, avgs, logger=None, metrics_file=None):
        sep = ''
        col1 = ':'
        lineLen = 64

        def log_print(msg):
            """Print to console, logger, and metrics file if available"""
            print(msg)
    ...
    def evaluate(self, pred_list, gt_list, logger=None, metrics_file=None):
        """
        Args:
            pred_list:
                for each scan:
            ...
            metrics_file: optional file handle for saving evaluation metrics
        """
        pool = mp.Pool()
        ...
        # print
        self.print_results(avgs, logger, metrics_file)
        return avgs
